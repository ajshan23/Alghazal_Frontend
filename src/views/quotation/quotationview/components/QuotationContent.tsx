...
const QuotationContent = () => {
    ...
    const handleUpdateImage = async (imageId: string, updateData: { title: string; description?: string }) => {
        if (!data) return;
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            await downloadQuotationPdf(data._id);
            toast.push(
                <Notification title="Success" type="success">
    ...
    // Transform items for ContentTable
