        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting, setErrors }) => {
                ...
                try {
                    ...
                    } else if (error.message?.includes('Shop with this number already exists')) {
                        setErrors({
                            shopNo: 'This shop number is already registered',
                        })
                    }
                }
            }}
