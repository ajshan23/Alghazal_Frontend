...
import { HiOutlineChevronUp, HiOutlineChevronDown, HiOutlineDocumentText } from 'react-icons/hi'
...
function _DataTable<T>(
    ...
    const Sorter = ({ column }: { column: any }) => {
    ...
    return (
        <Loading loading={loading && data.length !== 0} type="cover">
            <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg">
                <Table className="border-collapse w-full">
                    <THead>
                        {table.getHeaderGroups().map((headerGroup) => (
                            <Tr key={headerGroup.id} className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-750">
                                {headerGroup.headers.map((header) => {
                                    return (
                                        <Th
                                            key={header.id}
                                            colSpan={header.colSpan}
                                            className="px-6 py-4 text-left font-bold text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700"
                                        >
                                            <div
                                                className={classNames(
                                                    'flex items-center',
                                    ...
                                    >
                                        <div className="flex flex-col items-center justify-center">
                                            <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full mb-4">
                                                <HiOutlineDocumentText className="text-3xl text-gray-400 dark:text-gray-500" />
                                            </div>
                ...
                {data.length > 0 && (
                    <div className="space-y-4 p-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                        {totalAmount !== undefined && (
                            <div className="flex justify-end">
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 px-4 py-3 rounded-lg border border-blue-200 dark:border-blue-800 inline-flex items-center shadow-sm">
