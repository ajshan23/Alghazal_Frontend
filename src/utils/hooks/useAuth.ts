...
function useAuth() {
            ...
            if (response.status === 200) {
                ...
                if (user.role === "super_admin" || user.role === "admin") {
                    ...
                    if (user.role === "engineer") {
                        console.log('====================================');
                        console.log("hit engineer");
                        console.log('====================================');
                        // Use window.location.href for engineer
                        window.location.href = "/eng/myworks";
                    } else {
                        // Use window.location.href for driver
                        window.location.href = "/drv/soon";
                    }
                }
    ...
    const handleSignOut = () => {
        ...
        // Redirect to login page using window.location for complete reload
